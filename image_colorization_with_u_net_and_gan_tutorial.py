# -*- coding: utf-8 -*-
"""Image Colorization with U-Net and GAN Tutorial.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1B-4z-9EGJAB86XRjcFpTYftQ6sXrqk6I
...
"""With this simple function, we pretrain the generator for 20-25 epochs and then we save its weights. This will take an hour on Colab. In the following section, we will use this model as the generator for our GAN and train the whole network as before:
...
# /content/final_model_weights.pt
...
# Assuming model is loaded and to the same device as earlier
model.eval()

# Define the transform to match the input format of the model
transform = Compose([
...
image_path = '/content/ataturk-resmi-siyah-beyaz-2092.jpg'  # Replace with your image path
...
# Use the model's specific input setup method and forward pass
model.setup_input({'L': input_image})  # Adjust this based on your model's input setup
model.forward()

# Assuming the output is stored in an attribute of model after calling forward
output_image = model.fake_color  # Replace 'fake_color' with the correct attribute from your model

# Post-process the output image (e.g., convert it back to a PIL image)
output_image = to_pil_image(output_image.squeeze().cpu())
